...
const About = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-cover bg-center">
            ...
            >
                <div className="font-merriweather flex flex-col space-y-4 text-sm max-w-sm px-8 sm:px-0">
                    <h1 className="text-right text-white text-shadow text-xs">Info</h1>
                    <p className="text-justify text-white text-shadow">Tito Apiari was born November 2003 in Brazil. Tito is an electronic musician based in Salvador, Brazil.</p>
